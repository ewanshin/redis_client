...
bool CTestBase::Test_Get()
{
	...
	{
		std::cout << "CTestBase::Test_Get" << std::endl;
	...
	{
		std::cout << "[value:" << strVal.c_str() << "]" << std::endl;
		bSuccess = true;
	}
...
bool CTestBase::Test_Set()
{
	if (!InitStringEnv(2, 1) || !InitListEnv(3, 2))
	{
		std::cout << "CTestBase::Test_Set failed" << std::endl;
	...
	{
		bSuccess = true;
		std::cout << "CTestBase::Test_Set end" << std::endl;
	}
